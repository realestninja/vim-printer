...
let s:print_below_keybinding = get(g:, 'vim_printer_print_below_keybinding', '<leader>cl')
let s:print_above_keybinding = get(g:, 'vim_printer_print_above_keybinding', '<leader>cL')
